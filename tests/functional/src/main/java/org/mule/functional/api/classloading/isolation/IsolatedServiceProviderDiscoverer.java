...
public class IsolatedServiceProviderDiscoverer implements ServiceProviderDiscoverer {
   ...
   *
   * @param serviceArtifactClassLoaderAdapters list of classLoaders created for services already discovered during classification process
   *        artifactName will be the serviceProviderClassName used for instantiating the {@link ServiceProvider}
   */
